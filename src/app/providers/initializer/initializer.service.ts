...
//v6 import { StatusBar, Style } from '@capacitor/status-bar';
...
export class InitializerService {
   constructor(private platform: Platform, private logger: LoggerService, private properties: Properties, private fileSystem: FileSystemService, private translate: TranslateService) {}

   init(): Promise<void> {
      this.platform.ready().then(() => {
         //V6  StatusBar.setStyle({ style: Style.Light });
         SplashScreen.hide();
